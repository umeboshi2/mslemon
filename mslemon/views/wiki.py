...
from trumpet.views.base import PlainViewer
from trumpet.views.menus import BaseMenu

from mslemon.views.base import BaseViewer
from mslemon.views.base import make_main_menu
from mslemon.views.util import prepare_plain_layout

from mslemon.managers.wiki import WikiManager
...
<div class="article" about="/my/article">
  ...
  <div class="article-content" property="content">
    Some content
  </div>
</div>
"""
...
class PlainWikiViewer(PlainViewer):
    def __init__(self, request):
        super(PlainWikiViewer, self).__init__(request)
        # dispatch table
        ...
        prepare_plain_layout(self.layout)
    ...
    def edit_page(self):
        self.layout.resources.create_js.need()
        self.layout.resources.edit_wiki_page.need()
        self.css = None
        name = self.request.matchdict['pagename']
        ...
        if 'submit' in self.request.POST:
            ...
            self.layout.content = test_create_content
...
class WikiViewer(BaseViewer):
    ...
    def edit_page(self):
        ...
        self.layout.resources.hallo_js.need()
        self.layout.resources.edit_wiki_page.need()
        #self.css = None
        name = self.request.matchdict['pagename']
        page = self.pages.getbyname(name)
        ...
        form = deform.Form(schema, buttons=('submit',))
        self.layout.resources.deform_auto_need(form)
        template = 'mslemon:templates/edit-wiki-page.mako'
        env = dict(schema=schema, form=form, page=page)
