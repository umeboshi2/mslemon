...
(function() {
  var ace_editor_resource_urls, get_template, load_ace_editor_resources, load_fullcalendar_resources, make_alert, make_alert_div, make_javacript_tag, toggle_ace_keybinding, url_join;
  ...
  ace_editor_resource_urls = function(prefix) {
    var resources;
    resources = {
  ...
  make_javacript_tag = function(url) {
    var tag;
    tag = teacup.renderable(function() {
      return teacup.script({
  ...
  load_ace_editor_resources = function(mode) {
    var head, prefix, rsc, trumpet_theme;
    ...
    return head.append(make_javacript_tag(trumpet_theme));
  };

  load_fullcalendar_resources = function() {
    var google, head, main, prefix;
    ...
    return head.prepend(make_javacript_tag(google));
  };
