...
(function() {
  jQuery(function() {
    var admin_usrmgr_tmpl, create_template, editor_template, entry_template, list_titles, listview_template, main_group_view, main_user_view, side_view_template, user_entry_template, user_group_entry;
    list_titles = {
      user: 'Users',
      group: 'Groups'
    };
    ...
    admin_usrmgr_tmpl = {
      ...
      main_user_view: new EJS({
        text: main_user_view
      }),
      main_group_view: new EJS({
        text: main_group_view
      }),
      user_group_entry: new EJS({
        text: user_group_entry
      })
    };
