...
(function() {
  jQuery(function() {
    var admin_usrmgr_tmpl, create_template, editor_template, entry_template, list_titles, listview_template, main_group_view, main_user_view, side_view_template, user_entry_template;
    list_titles = {
      user: 'Users',
      group: 'Groups'
    };
