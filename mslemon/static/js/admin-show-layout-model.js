...
(function() {
  $(document).ready(function() {
    var add_new_field_button, create_editor, div, editing_space, editor_template, field_for_model_selected, field_list, header_template, icon, input, label, renderable, select_field_widget, select_fields_for_model, span, strong, text;
    ...
    create_editor = function(model_id, field_id, ftype) {
      var editor, fresh_edit, html, save_button, save_edit_error, session;
    ...
    $('.delete-button').click(function() {
      ...
      oldtext = $('.header').text();
      if (oldtext === 'Ms. Lemon') {
        return $('.header').html(header_template('Delete-' + id));
      } else {
        return $('.header').html(header_template('Ms. Lemon'));
      }
    });
